...
| `/plan`                   | Turn any source document (code review, backlog, refactor notes, …) into a milestone-based plan.      |
| `/backlog`                | Record a backlog of improvements, bugs, and ideas one at a time, or extend an existing one, as Markdown or HTML. |
